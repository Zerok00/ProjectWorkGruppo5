...
#stazione501 : coord
#lista_sensori = [(20429, pm2.5, 30.2), (5504, ...), (6328, ...), ecc.]

for elem in lista_finale: #elem[1], elem[2]
...
for elemento in dizionario_stazione_posizione_sensori:
    print()
    print(elemento)
    print(dizionario_stazione_posizione_sensori[elemento]["coord"])
    print(dizionario_stazione_posizione_sensori[elemento]["lista_sensori"])
