...
path_qa = r'data\Stazioni_qualit__dell_aria_20240220.csv'
...
path_qa = r'data\Dati_sensori_aria_20240219.csv'
...
operations.inserimento_rilevazioni(path_rilevazioni_qa, path_stazioni_qa, execute=True)


path_meteo = r'data\stazioni_meteo.csv'
...
path_meteo = r'data\Dati_sensori_meteo_20240220.csv'
...
operations.inserimento_rilevazioni(path_rilevazioni_meteo, path_stazioni_meteo, execute=False)
